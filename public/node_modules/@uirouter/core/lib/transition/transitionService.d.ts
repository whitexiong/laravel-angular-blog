import { IHookRegistry, TransitionOptions, TransitionHookScope, TransitionHookPhase, TransitionCreateHookFn, HookMatchCriteria, HookRegOptions, PathTypes, PathType, RegisteredHooks, TransitionHookFn, TransitionStateHookFn } from '@uirouter/core/lib/transition/interface';
import { Transition } from '@uirouter/core/lib/transition/transition';
import { RegisteredHook } from '@uirouter/core/lib/transition/hookRegistry';
import { TargetState } from '@uirouter/core/lib/state/targetState';
import { PathNode } from '@uirouter/core/lib/path/pathNode';
import { ViewService } from '@uirouter/core/lib/view/view';
...
import { GetResultHandler, GetErrorHandler } from '@uirouter/core/lib/transition/transitionHook';
