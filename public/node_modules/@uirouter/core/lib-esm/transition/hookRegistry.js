import { isString, isFunction, Glob, extend, removeFrom, tail, values, identity, mapObj } from '@uirouter/core/lib/common';
import { // has or is using
TransitionHookScope, } from '@uirouter/core/lib/transition/interface';
/**
