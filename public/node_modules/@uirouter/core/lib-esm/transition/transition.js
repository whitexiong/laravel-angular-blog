import { trace } from '@uirouter/core/lib/common/trace';
import { services } from '@uirouter/core/lib/common/coreservices';
import { stringify } from '@uirouter/core/lib/common/strings';
import { map, find, extend, mergeR, tail, omit, arrayTuples, unnestR, identity, anyTrueR } from '@uirouter/core/lib/common/common';
import { isObject, isUndefined } from '@uirouter/core/lib/common/predicates';
import { prop, propEq, val, not, is } from '@uirouter/core/lib/common/hof';
import { TransitionHookPhase, } from '@uirouter/core/lib/transition/interface'; // has or is using
import { TransitionHook } from '@uirouter/core/lib/transition/transitionHook';
import { matchState, makeEvent } from '@uirouter/core/lib/transition/hookRegistry';
import { HookBuilder } from '@uirouter/core/lib/transition/hookBuilder';
import { PathUtils } from '@uirouter/core/lib/path/pathUtils';
import { Param } from '@uirouter/core/lib/params/param';
import { Resolvable } from '@uirouter/core/lib/resolve/resolvable';
import { ResolveContext } from '@uirouter/core/lib/resolve/resolveContext';
import { Rejection } from '@uirouter/core/lib/transition/rejectFactory';
import { flattenR, uniqR } from '@uirouter/core/lib/common';
/** @internal */
