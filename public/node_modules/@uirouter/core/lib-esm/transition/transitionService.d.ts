import { IHookRegistry, TransitionOptions, TransitionHookScope, TransitionHookPhase, TransitionCreateHookFn, HookMatchCriteria, HookRegOptions, PathTypes, PathType, RegisteredHooks, TransitionHookFn, TransitionStateHookFn } from '@uirouter/core/lib-esm/transition/interface';
import { Transition } from '@uirouter/core/lib-esm/transition/transition';
...
import { ViewService } from '@uirouter/core/lib-esm/view/view';
import { UIRouter } from '@uirouter/core/lib-esm/router';
import { TransitionEventType } from '@uirouter/core/lib-esm/transition/transitionEventType';
import { GetResultHandler, GetErrorHandler } from '@uirouter/core/lib-esm/transition/transitionHook';
