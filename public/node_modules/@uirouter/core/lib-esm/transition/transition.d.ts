import { StateDeclaration, StateOrName } from '@uirouter/core/lib-esm/state/interface';
import { TransitionOptions, TreeChanges, IHookRegistry, RegisteredHooks, HookRegOptions, HookMatchCriteria, TransitionStateHookFn, TransitionHookFn } from '@uirouter/core/lib-esm/transition/interface';
import { RegisteredHook } from '@uirouter/core/lib-esm/transition/hookRegistry';
import { PathNode } from '@uirouter/core/lib-esm/path/pathNode';
import { StateObject } from '@uirouter/core/lib-esm/state/stateObject';
import { TargetState } from '@uirouter/core/lib-esm/state/targetState';
import { Resolvable } from '@uirouter/core/lib-esm/resolve/resolvable';
import { ViewConfig } from '@uirouter/core/lib-esm/view/interface';
import { UIRouter } from '@uirouter/core/lib-esm/router';
import { UIInjector } from '@uirouter/core/lib-esm/interface';
import { ResolvableLiteral } from '@uirouter/core/lib-esm/resolve/interface';
import { Rejection } from '@uirouter/core/lib-esm/transition/rejectFactory';
/**
