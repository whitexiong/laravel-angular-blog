...
import { UrlRouter } from '@uirouter/core/lib-esm/url/urlRouter';
import { TransitionService } from '@uirouter/core/lib-esm/transition/transitionService';
import { ViewService } from '@uirouter/core/lib-esm/view/view';
import { StateRegistry } from '@uirouter/core/lib-esm/state/stateRegistry';
import { StateService } from '@uirouter/core/lib-esm/state/stateService';
import { UIRouterGlobals } from '@uirouter/core/lib-esm/globals';
import { UIRouterPlugin, Disposable } from '@uirouter/core/lib-esm/interface';
import { UrlService } from '@uirouter/core/lib-esm/url/urlService';
import { LocationServices, LocationConfig } from '@uirouter/core/lib-esm/common/coreservices';
import { Trace } from '@uirouter/core/lib-esm/common/trace';
/**
